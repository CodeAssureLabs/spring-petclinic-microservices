...
/**
 * Formats a short, human-readable summary line for a {@link Pet}.
 */
public final class PetSummaryFormatter {

    private PetSummaryFormatter() {
    }

    /**
     * Builds a one-line summary such as {@code "Leo (cat)"}.
